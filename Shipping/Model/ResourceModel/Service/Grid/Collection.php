...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    {
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, 'samedaycourier_shipping_service', \SamedayCourier\Shipping\Model\ResourceModel\Service::class, $identifierName, $connectionName);
